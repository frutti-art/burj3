...
<body class="container mx-auto max-w-3xl p-2 md:px-24 pb-24 absolute inset-0 h-full w-full bg-slate-50 bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:16px_16px] dark:bg-[#15202B] dark:bg-none">
