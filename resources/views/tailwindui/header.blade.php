                ...
                <div class="flex items-center border-b border-gray-200 px-2 pb-2 pt-1">
                    <dl class="flex flex-1 text-sm">
                        <div class="flex pr-8 items-center space-x-1">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 text-blue-600 dark:text-blue-500">
...
{{--                            <dd class="text-gray-500">Level:</dd>--}}
                        ...
                        <div class="flex items-center justify-end flex-shrink-0 ml-auto">
                            <svg id="theme-toggle" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 text-blue-600 dark:text-blue-500">
