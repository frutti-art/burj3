...
@section('content')
    ...
    <div class="gap-x-4 mt-24 border rounded-2xl shadow-lg border-gray-900/5 bg-gray-100 dark:bg-[#192734] mx-4">
        ...
        <div id="feed-container" class="p-4 h-96">
            <div class="flow-root">
                <ul id="feed-list" role="list" class="-mb-8">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            function createFeedItem(content) {
                ...
                newItem.classList.add('relative', 'pb-8', 'feed-item');
                newItem.innerHTML = `
            <div class="relative flex space-x-3">
                ...
                <div class="flex min-w-0 flex-1 justify-between space-x-4 pt-1.5">
                    ...
                    <div class="whitespace-nowrap text-right text-sm text-gray-500 dark:text-[#8899A6]">
                        <time datetime="2020-09-28">13s ago</time>
                    </div>
                </div>
            </div>
        `;
            ...
            function updateFeed() {
                // Create and insert new feed item
                ...
                // Slide up and remove the first item if more than 5 items
